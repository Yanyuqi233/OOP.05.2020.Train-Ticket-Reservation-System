 ...
 */
public class 订单详情JFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "车次", "出发日期", "出发地", "到达地", "出发时间", "到达时间", "座位类型", "硬卧备注", "软卧备注", "价格", "预订时间"
            }
        ));
...
new 乘客个人中心JFrame().setVisible(true); // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(订单详情JFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void fillTable(train train) {
		...
		try {
			con = database.getCon();
			ResultSet rs = co.Querytrainorder(con,passenger);
			while (rs.next()) {
				Vector v = new Vector();
